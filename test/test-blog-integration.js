...
//function generateAuthorName() {
 // const firstNames = [
  //  'Man', 'Queen', 'Brook', 'Bronx', 'State'];
 // return firstNames[Math.floor(Math.random() * firstNames.length)];
//}

//not sure how to best set this up---separate for firstname and last name?
//or can i just use faker here

//function generateAuthorName() {
  //const lastName = [
   // 'Can', 'Teen', 'Book', 'Lonx', 'Tate'];
  //return boroughs[Math.floor(Math.random() * lastName.length)];

// used to generate data to put in db
function generateTitle() {
  const titles = ['Post1', 'Post2', 'Post3'];
...
// note the use of nested `describe` blocks.
        ...
        .then(function(res) {
          ...
          res.body.forEach(function(post) {
            ...
            expect(post).to.include.keys(
              'author', 'title', 'content', 'created'); //not sure if i should have author or first name last name
          });
  ...
  describe('PUT endpoint', function() {
    ...
    it('should update fields you send over', function() {
      const updateData = {
        author: { firstName: 'fofofofofofofof',
